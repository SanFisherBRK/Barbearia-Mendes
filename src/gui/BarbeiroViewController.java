...
public class BarbeiroViewController {
    ...
    // Cria as variáveis do tipo TextField que é os campos onde você digita as informações
    @FXML
    ...
    // Faz com que as variáveis da classe Cliente receba nelas o que foi digitado nos campos do formulario.
    public void cadastrarBarbeiros() throws SQLException {
        ...
        try (Connection conn = new Conexao().getConnection();
            ...
            if (barbeiro.getNome().isEmpty() || barbeiro.getEmail().isEmpty() || barbeiro.getTelefone().isEmpty()
                ...
                Alerts.showAlert("Cadastrar Cliente", "Preencha todos os campos", "Tentar de novo", AlertType.INFORMATION);
